...
class _AddVehicleState extends State<AddVehicle> {
  ...
  void initState() {
    ...
    vehicleDataFuture = adminAddVehicleController.fetchVehicleDetails(widget.vehicleId);
  }
    ...
    return FutureBuilder<DocumentSnapshot<Map<String, dynamic>>>(
        ...
        builder: (context, snapshot) {
          if (snapshot.connectionState == ConnectionState.waiting) {
            ...
            // Data has been fetched successfully, display the scaffold with the data
            var vehicleData = snapshot.data?.data() ?? Map<String, dynamic>();
                          ...
                          child: Column(
                            children: [
                              ...
                              Container(
                                ...
                                height: 60,
                                child: TextField(
                                  controller: adminAddVehicleController
                                      .vehicleNumber,
                                  decoration: InputDecoration(
                                      border: OutlineInputBorder(

  ...
  void addReceivedVehicle() async {
    try {
      ...
      await bookingsCollection.doc(documentId).update({
        ...
        'owner_message_to_customer':
            mainController.ownerMessageToCustomerController.text,
        'owner_rating_to_rider':
            mainController.ownerRatingToRiderController.text,
      ...
      // to the user indicating that the update was not successful.
                  ...
                  if (customerSnapshot.connectionState ==
                    ...
                    return Container(
                      ...
                      color: Colors.black.withOpacity(
                          0.8), // Adjust the opacity (0.5 means 50% transparent)
                      child: const Center(
  ...
  Widget _submitButton(BuildContext context) {
    return SizedBox(
      ...
      child: ElevatedButton(
        ...
        onPressed: () {
          addReceivedVehicle();
          Get.to(const RatingCongratulation());
        },
        child: const Center(
          child: Text(
            "Submit",

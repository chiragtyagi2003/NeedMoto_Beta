...
import 'package:need_moto/owner/screens/photos_upload.dart';
import 'package:need_moto/owner/screens/tax_file_upload.dart';
            ...
            child: _currentStep == 2
                ? ElevatedButton(
                    ...
                    onPressed: () async {
                      ...
                      await Get.find<OwnerMainController>().saveVehicleDataToFirestore();

                      await Get.find<OwnerFileController>().uploadFiles();

                      await Get.find<OwnerImageController>().uploadImagesToFirebase();
